...
import fr.isika.projet4.ServerSpringBoot.constant.EmailConfidential;
import fr.isika.projet4.ServerSpringBoot.constant.EmailConstant;
...
public class EmailService {
	...
	public void sendNewPassWordEmail(String firstName, String passWord, String email) throws MessagingException {
		...
		smtpTransport.connect(EmailConstant.GMAIL_SMTP_SERVER, emailConfidential.getUsername(), emailConfidential.getPassword());
